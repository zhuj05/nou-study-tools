...
ACADEMIC_CALENDAR_DATA_115: dict[str, dict] = {
    ...
    "115_2": {
        ...
        "events": [
            ...
            (datetime.date(2027, 4, 18), "• ⭐ 116.04.17 ～ 116.04.18 ｜ 115下期中考試"),
            (datetime.date(2027, 4, 25), "• 116.04.24 ～ 116.04.25 ｜ 115下期中考補考"),
            (datetime.date(2027, 5, 20), "• 116.05.01 ～ 116.05.20 ｜ 116暑期網路選課"),
            (datetime.date(2027, 5, 31), "• 116.05.23 ～ 116.05.31 ｜ 116暑期線上逾期補選課"),
            (datetime.date(2027, 6, 20), "• ⭐ 116.06.19 ～ 116.06.20 ｜ 115下期末考試"),
            (datetime.date(2027, 6, 27), "• 116.06.26 ～ 116.06.27 ｜ 115下期末考補考"),
        ],
    },
    "115_summer": {
        "title": "📌 115學年度 暑期",
