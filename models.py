...
ACADEMIC_CALENDAR_DATA_115: dict[str, dict] = {
    "115_1": {
        ...
        "events": [
            ...
            (datetime.date(2026, 9, 23), "• 115.09.23 ｜ 115暑期末考考試成績，開放網路查詢"),
            (datetime.date(2026, 9, 24), "• 115.09.24 ｜ 115暑學期成績開放網路查詢"),
            
            (datetime.date(2026, 9, 28), "•🟢 115.09.25 ~ 09.28 ｜ 中秋節及教師節連假 休4天"),
            (datetime.date(2026, 10, 11), "•🟢 115.10.09 ~10.11 ｜ 國慶日連假 休3天"),
            (datetime.date(2026, 10, 14), "• 115.10.14 ｜ 寄發115暑成績單"),
            (datetime.date(2026, 10, 26), "•🟢 115.10.24 ~ 10.26 ｜ 光復節連假 休3天"),                        
            (datetime.date(2026, 11, 30), "• 115.10.25 ~ 11.30 ｜ 115下招生網路報名"),
            (datetime.date(2026, 11, 8), "• ⭐ 115.11.07 ～ 11.08 ｜ 115上期中考試"),
            ...
            (datetime.date(2026, 12, 20), "• 115.12.01 ～ 12.20 ｜ 115下舊生網路選課繳費"),
            (datetime.date(2026, 12, 31), "• 115.12.23 ～ 12.31 ｜ 115下線上逾期補選課、補繳費"),
            (datetime.date(2026, 12, 27), "•🟢 115.12.25 ~ 12.27 ｜ 行憲紀念日連假 休3天"),            
